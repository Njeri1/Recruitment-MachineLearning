...
if __name__ == '__main__':
    id_list = list()
    my_list = list()
    jobDescription = JobDescription('C:/Users/ALU STUDENT/Downloads/Year 4/Capstone/Resume-rating-using-NLP-and-Flask-main/Resume-rating-using-NLP-and-Flask-main/Resume_sort/src/Job_description/jobDescription1.txt')
